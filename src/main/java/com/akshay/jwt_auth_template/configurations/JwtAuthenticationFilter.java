...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // if email present in token and this request is not already authenticated by previous filters in filter chain
            if (userEmail != null && authentication == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails)) {
                    ...
                    authToken.setDetails(new WebAuthenticationDetailsSource().buildDetails(request)); // Optional, to set request details in security context
